export default {
  ...
  actionUnassignSelf: "Unassign me",
  // Assignee picker (GitHub-style popup)
  assignTitle: "Assign to",
  assignSearchPlaceholder: "Search members…",
  assignNoMembers: "No members found",
  // Assigned-to-me pinned category
  assignedToMe: "Assigned to me",
  assignedToMeCount: "{count} assigned",
  assignedToMeEmpty: "Nothing assigned to you",
  assignedToMeEmptyDesc: "Todos assigned to you across all lists show up here.",
  assignedToMeUnknownList: "Ungrouped",
  assignedToMeOpenList: "Open list",
  ...
  permLabel_assign_todos: "Assign Todos",
  permDesc_assign_todos: "Assign todos to team members (or yourself)",
