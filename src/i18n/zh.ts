...
const zh: typeof en = {
  ...
  actionSelectAll: "全选",
  actionAssign: "分配…",
  actionAssignSelf: "分配给我",
  actionUnassignSelf: "取消分配给我",
  // 分配选择器（GitHub 风格弹窗）
  assignTitle: "分配给",
  assignSearchPlaceholder: "搜索成员…",
  assignNoMembers: "未找到成员",
  // 置顶「分配给我」分类
  assignedToMe: "分配给我",
  assignedToMeCount: "{count} 项待办",
  assignedToMeEmpty: "暂无分配给你的待办",
  assignedToMeEmptyDesc: "所有列表中分配给你的待办都会显示在这里。",
  assignedToMeUnknownList: "未分组",
  assignedToMeOpenList: "打开列表",
  ...
  permLabel_assign_todos: "分配任务",
  permDesc_assign_todos: "将任务分配给团队成员（或自己）",
