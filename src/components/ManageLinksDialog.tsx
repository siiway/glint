                    ...
                    <div key={link.id} className={styles.linkCard}>
                        ...
                        <>
                          <div className={styles.fieldRow}>
                            ...
                            >
                              ...
                              <option value="full">{t.linksFullAccess}</option>
                      ...
                      <div>
                        <Button
                          ...
                          onClick={() =>
                            setExpandedBadge(
                              expandedBadge === link.token ? null : link.token,
                            )
                          }
                        >
                          {t.shareBadge}
                            ...
                            <div className={styles.actions}>
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  setCopied(`md-${link.token}`);
                                  setTimeout(() => setCopied(null), 2000);
                                }}
                              >
                                {copied === `md-${link.token}`
                                  ? t.shareCopied
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  setCopied(`url-${link.token}`);
                                  setTimeout(() => setCopied(null), 2000);
                                }}
                              >
                                {copied === `url-${link.token}`
                                  ? t.shareCopied
                                  : t.shareBadgeCopyUrl}
                              </Button>
                            </div>
