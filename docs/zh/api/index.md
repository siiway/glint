...
| `PUT` | `/api/teams/:teamId/todos/:id/assignees` | 设置待办的被分配人（`assign_todos`） |
| `GET` | `/api/teams/:teamId/members` | 列出可被分配的成员 |
| `GET` | `/api/teams/:teamId/assigned-to-me` | 分配给我的待办，按列表分组 |
| `POST` | `/api/teams/:teamId/assigned-expand` | 持久化"分配给我"列表的展开状态 |
...
| `PUT` | `/api/cross-app/teams/:teamId/todos/:todoId/assignees` | 设置待办的被分配人（`assign_todos`） |
| `GET` | `/api/cross-app/teams/:teamId/assigned-to-me` | 分配给我的待办（单个工作区） |
| `GET` | `/api/cross-app/assigned-to-me` | 分配给我的待办（所有工作区） |
