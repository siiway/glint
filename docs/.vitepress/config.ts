...
const guideSidebar = (prefix = "") => [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Share Links", link: `${prefix}/guide/shares` },
...
const apiSidebar = (prefix = "") => [
  {
    ...
    items: [
      ...
      { text: "User Settings", link: `${prefix}/api/user-settings` },
      ...
      { text: "Share Links", link: `${prefix}/api/shares` },
...
const zhGuideSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "分享链接", link: "/zh/guide/shares" },
